...
class SecretNumber {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Guess the secret number. Press 0 to exit.");
        while (true) {
            int guess = 0;
            ...
            if (guess < 1 || guess > 100)
                System.out.println("The secret number is within the range of 1-100. Try again.");
            ...
            if (guess != secret) {
                ...
                System.out.println("Your guess was " + intensifier + (isLow ? " low." : " high."));
            }
